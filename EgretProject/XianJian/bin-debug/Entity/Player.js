...
var Player = (function (_super) {
    ...
    Player.prototype.createChildren = function () {
        ...
        var esWeaponMovieClip = new Array();
        var neWeaponMovieClip = new Array();
        var idle_es = this.createMovieClip("idle", this.direction_up);
        var idle_ne = this.createMovieClip("idle", this.direction_down);
        var weapon_idle_es = this.createFileClip("idle", this.direction_up);
        var weapon_idle_ne = this.createFileClip("idle", this.direction_down);
        ...
        var weapon_run_es = this.createFileClip("run", this.direction_up);
        var weapon_run_ne = this.createFileClip("run", this.direction_down);
    ...
    Player.prototype.createFileClip = function (type, direction) {
